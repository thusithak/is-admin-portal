...
class SamlConfigHeader extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
                ...
                <Grid container spacing={0} alignItems="center" direction="column" justify="center">
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        <Typography variant="headline" className={this.props.classes.pageHeadline} align="center">
                            SAML2 Web SSO Configuration with Metadata
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        <Typography variant="subheading" className={this.props.classes.pageSubheading} align="center" color="textSecondary">
                            There are two quick methods you can use to configure SSO.
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        <Button className={this.props.classes.button} variant="raised" color="primary" >
                            <FileUpload className={this.props.classes.iconSmall}/>
                            Upload File
                        </Button>
                        <Button className={this.props.classes.button} variant="raised" color="primary">
                            <LinkIcon className={this.props.classes.iconSmall}/>
                            Add Url
                        </Button>
                    </Grid>
                </Grid>
...
export default withStyles(styles)(SamlConfigHeader);
